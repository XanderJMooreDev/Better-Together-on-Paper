...
else if (obj_game_manager.teamNums[1] == 2 && obj_game_manager.teamNums[2] == 2 || obj_game_manager.teamNums[0] == 2 && obj_game_manager.teamNums[2] == 2 ) {
	sprite_index = ds_list_find_value(obj_game_manager.playerHats, obj_game_manager.playerHatIDs[3]);
}
else if (obj_game_manager.teamNums[0] == 2 && obj_game_manager.teamNums[3] == 2 || obj_game_manager.teamNums[1] == 2 && obj_game_manager.teamNums[3] == 2 || obj_game_manager.teamNums[2] == 2 && obj_game_manager.teamNums[3] == 2) {
